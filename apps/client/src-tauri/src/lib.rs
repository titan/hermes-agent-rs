...
async fn send_message(
    ...
    let reply = if mode == "local" {
        ...
        match local_agent::run_agent_streaming(
            &content,
            &model,
            move |delta_type, text, tool_name| {
                eprintln!(
                    "[hermes-app] EMIT stream-delta: type={}, len={}",
                    delta_type,
                    text.len()
                );
        ...
        match hermes_client::send_message_stream(
            &api_base,
            &sid,
            &content,
            move |event_type, text, tool_name| {
...
fn get_automation_tasks() -> Vec<AutomationTask> {
    vec![
        AutomationTask {
            id: "1".into(),
            title: "Summarize yesterday's git activity for standup.".into(),
            description: "Status reports".into(),
            icon: "📝".into(),
            category: "Status reports".into(),
        },
        AutomationTask {
            id: "2".into(),
            title:
        ...
        AutomationTask {
            id: "3".into(),
            title: "Summarize last week's PRs by teammate and theme; highlight risks.".into(),
            description: "Status reports".into(),
            icon: "🖥️".into(),
            category: "Status reports".into(),
        },
        AutomationTask {
            ...
            title: "Draft weekly release notes from merged PRs (include links when available)."
                .into(),
            description: "Release prep".into(),
            icon: "📮".into(),
            category: "Release prep".into(),
        },
        AutomationTask {
            id: "5".into(),
            title: "Before tagging, verify changelog, migrations, feature flags, and tests.".into(),
            description: "Release prep".into(),
            icon: "✅".into(),
            category: "Release prep".into(),
        },
        AutomationTask {
            id: "6".into(),
            title: "Update the changelog with this week's highlights and key PR links.".into(),
            description: "Release prep".into(),
            icon: "✏️".into(),
            category: "Release prep".into(),
        },
        AutomationTask {
            id: "7".into(),
            title: "Triage new issues: label, assign, and flag anything blocking.".into(),
            description: "Incidents & triage".into(),
            icon: "🔍".into(),
            category: "Incidents & triage".into(),
        },
        AutomationTask {
            id: "8".into(),
            title: "Summarize open incidents and their current status.".into(),
            description: "Incidents & triage".into(),
            icon: "💬".into(),
            category: "Incidents & triage".into(),
        },
